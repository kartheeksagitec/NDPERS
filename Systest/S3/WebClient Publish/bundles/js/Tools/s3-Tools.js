...
app.controller("projectconfigurationcontroller", ["$scope", "$rootScope", "$EntityIntellisenseFactory", "$getEnitityXmlMethods", "$filter", "$timeout", function ($scope, $rootScope, $EntityIntellisenseFactory, $getEnitityXmlMethods, $filter, $timeout) {
    ...
    $scope.addEditCommonProperty = function (commonProperty) {
        ...
        if (commonProperty) {
            ...
            newScope.BaseAppModel = commonProperty.BaseAppModel;
            newScope.IsBaseAppModel = commonProperty.IsBaseAppModel;
        }
        else {
            newScope.id = "";
    ...
    $scope.canDeleteCommonProperty = function () {
        return $scope.selectedCommonProperty && !$scope.selectedCommonProperty.IsBaseAppModel;
    };
    ...
    $scope.canDeleteObject = function () {
        return $scope.selectedObject && !$scope.selectedObject.IsBaseAppModel;
    };
    ...
    $scope.canDeleteObjectItem = function (object) {
        return object.selectedObjectItem && !object.selectedObjectItem.IsBaseAppModel;
    };
    ...
    $scope.canDeleteStandardBookmark = function () {
        return $scope.selectedStandardBookmark && !$scope.selectedStandardBookmark.IsBaseAppModel;
    };
    ...
    $scope.canDeleteStandardBookmarkItem = function (parentBookmark) {
        return parentBookmark.selectedStandardBookmarkItem && !parentBookmark.selectedStandardBookmarkItem.IsBaseAppModel;
    };
    ...
    $scope.AddOrEditStandardBookMark = function (objBookMarkParent, objStdBookMark, param) {
        ...
        newStdBookMarkScope.IsBaseAppModel = objStdBookMark.IsBaseAppModel || objStdBookMark.BaseAppModel;
    ...
    $scope.canDeleteGlobalParameter = function () {
        return $scope.selectedGlobalParameter && !$scope.selectedGlobalParameter.IsBaseAppModel;
    };
    ...
    $scope.canDeletePortal = function () {
        return $scope.selectedPortal && !$scope.selectedPortal.IsBaseAppModel;
    };
    $scope.deletePortal = function () {
    ...
    $scope.updateModelForBaseAppModel = function (updateParentName) {
        if ($scope.IsBaseAppFile && $scope.projectconfigurationfiledata && $scope.projectconfigurationfiledata.BaseAppModel) {
            $scope.$evalAsync(function () {
                updateModelForBaseAppModel($scope.projectconfigurationfiledata, $scope.projectconfigurationfiledata.BaseAppModel, updateParentName);
            });
        }
    };
