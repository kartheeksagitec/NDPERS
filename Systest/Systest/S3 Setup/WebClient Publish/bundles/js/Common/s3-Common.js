...
function GetBaseModel(data) {
    if (data) {
        var objNewObject = {
            prefix: data.prefix, Name: data.Name, Value: data.Value, dictAttributes: {}, Elements: [], Children: [], IsValueInCDATAFormat: data.IsValueInCDATAFormat
        };
        ...
        link: function (scope, element, attrs) {
            ...
            scope.AddClsEntity = function (strEntityname, strdisplayName, strParentEntity, strDataTypeOfField) {
                ...
                if (Entity == "") {
                    ...
                    var strattr = JSON.stringify(entattributes);
