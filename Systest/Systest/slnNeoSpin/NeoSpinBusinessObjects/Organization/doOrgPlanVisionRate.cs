...
{
    [Serializable]
    public class doOrgPlanVisionRate : doBase
    {
         
         public doOrgPlanVisionRate() : base()
         {
         }
		private int _org_plan_vision_rate_id;
		public int org_plan_vision_rate_id
		{
			get
			{
				return _org_plan_vision_rate_id;
			}

			set
			{
				_org_plan_vision_rate_id = value;
			}
		}
