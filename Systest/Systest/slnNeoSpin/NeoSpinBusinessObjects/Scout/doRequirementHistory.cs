...
{
    [Serializable]
    public class doRequirementHistory : doBase
    {
         
         public doRequirementHistory() : base()
         {
         }
		private int _requirement_history_id;
		public int requirement_history_id
		{
			get
			{
				return _requirement_history_id;
			}

			set
			{
				_requirement_history_id = value;
			}
		}
