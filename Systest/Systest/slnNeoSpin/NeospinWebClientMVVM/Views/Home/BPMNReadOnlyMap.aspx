...
<head>
    ...
    <%:@System.Web.Optimization.Scripts.Render("~/BPMExecution/Scripts/kendo.all.min.js")%>
...
<body onload="">
    ...
    <div id="map">
        ...
        <button title="Demo" style="display:none;" id="btnDemo">Demo</button>

        <button title="Run" style="display:none;" id="btnRun">Run</button>
