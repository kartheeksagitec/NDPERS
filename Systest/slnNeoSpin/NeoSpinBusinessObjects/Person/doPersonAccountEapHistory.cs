...
{
	/// <summary>
	/// Class NeoSpin.DataObjects.doPersonAccountEapHistory:
	/// Inherited from doBase, the class is used to create a wrapper of database table object.
	/// Each property of an instance of this class represents a column of database table object.  
	/// </summary>
    [Serializable]
    public class doPersonAccountEapHistory : doBase
    {
         
         public doPersonAccountEapHistory() : base()
         {
         }
         public int person_account_eap_history_id { get; set; }
    ...
    [Serializable]
    public enum enmPersonAccountEapHistory
    {
         person_account_eap_history_id ,
         person_account_id ,
         start_date ,
         end_date ,
         provider_org_id ,
