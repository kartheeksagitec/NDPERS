...
{
	/// <summary>
	/// Class NeoSpin.DataObjects.doPersonAccountInsuranceTransfer:
	/// Inherited from doBase, the class is used to create a wrapper of database table object.
	/// Each property of an instance of this class represents a column of database table object.  
	/// </summary>
    [Serializable]
    public class doPersonAccountInsuranceTransfer : doBase
    {
         
         public doPersonAccountInsuranceTransfer() : base()
         {
         }
    ...
    [Serializable]
    public enum enmPersonAccountInsuranceTransfer
    {
