<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmLoginEEAlt.aspx.cs" Inherits="NeoSpinESS.wfmLoginEEAlt" %>
...
<head id="sfwPageHeader" runat="server">
    <title>PERSLink Web Self Service - Login</title>
...
<body class="LoginBody" onload="SetWindowName()">
    <form id="wfmNeoSpinBase" runat="server" submitdisabledcontrols="true">
    <asp:Panel runat="server" ID="pnlBase" DefaultButton="btnLogin">
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="LoginBgESS">
            ...
            <tr style="height: 20px;">
                <td colspan="2" style="padding-left: 30px; padding-right: 30px;">
                    <swc:sfwLabel runat="server" ID="lblError" Font-Bold="true" ForeColor="White" />
                </td>
            </tr>
            ...
            <tr style="height: 25px;">
                <td valign="top" align="right" style="padding-left: 30px;">
                    <swc:sfwLabel ID="lblEmpType" runat="server" Text="Employer Type :" CssClass="loginTxt"
                        Font-Bold="true"></swc:sfwLabel>
                </td>
                <td valign="top">
                    ...
                    <br />
                    <br />
                    <swc:sfwButton runat="server" Text="Login" ID="btnLogin" OnClick="btnLogin_Click" />
                </td>
            </tr>
