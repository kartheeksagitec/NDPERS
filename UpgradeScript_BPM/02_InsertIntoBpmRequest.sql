...
-- =============================================
CREATE TRIGGER [dbo].[InsertIntoBpmRequest] 
...
BEGIN
	...
	SELECT DOCUMENT_CODE,NULL,REFERENCE_ID,PERSON_ID,@ORG_ID,7026,'UNPC',2021,'INDX',@ADDITIONAL_INFO,@CREATED_BY,@CREATED_DATE,@MODIFIED_BY,@MODIFIED_DATE,@UPDATE_SEQ,3008,'NORM',3013,'Y' FROM INSERTED
