	...
	public partial class busWFMimicIndexing : busExtendBase
    {
        ...
        private void AddImageDataToDatabase(string lstrDocCategory, ArrayList larrResult, utlError lobjError, string lstrFilenetDocType)
        {
            try
            {
                ...
                //venkat to check
                icdoWorkflowRequest.org_id = busGlobalFunctions.GetOrgIdFromOrgCode(_istrOrgCodeId);
                icdoWorkflowRequest.doc_type = _istrDocumentCode;
                ...
                RequestAdditionalInfo obj = new RequestAdditionalInfo() { FILENET_DOCUMENT_TYPE = lstrFilenetDocType, IMAGE_DOC_CATEGORY = lstrDocCategory };
                icdoWorkflowRequest.additional_info = HelperFunction.JsonSeserialize(obj);
                icdoWorkflowRequest.status_value = BpmRequestStatus.NotProcessed;
                icdoWorkflowRequest.source_value = BpmRequestSource.ScanAndIndex;
