...
{
	/// <summary>
	/// Class NeoSpin.DataObjects.doBenefitOptionFactor:
	/// Inherited from doBase, the class is used to create a wrapper of database table object.
	/// Each property of an instance of this class represents a column of database table object.  
	/// </summary>
    [Serializable]
    public class doBenefitOptionFactor : doBase
    {
         
         public doBenefitOptionFactor() : base()
         {
         }
         public int benefit_option_factor_id { get; set; }
    ...
    [Serializable]
    public enum enmBenefitOptionFactor
    {
         benefit_option_factor_id ,
         member_age ,
         ben_age ,
         benefit_type ,
         benefit_option_id ,
