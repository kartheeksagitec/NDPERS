...
{
	/// <summary>
	/// Class NeoSpin.DataObjects.doContactTicketHistory:
	/// Inherited from doBase, the class is used to create a wrapper of database table object.
	/// Each property of an instance of this class represents a column of database table object.  
	/// </summary>
    [Serializable]
    public class doContactTicketHistory : doBase
    {
         
         public doContactTicketHistory() : base()
         {
         }
         public int contact_ticket_history_id { get; set; }
         ...
         public string publish_wss { get; set; }
         public string callback_phone_2 { get; set; }
         public string extn { get; set; }
         public string extn2 { get; set; }
    }
    [Serializable]
    public enum enmContactTicketHistory
    {
         contact_ticket_history_id ,
         contact_ticket_id ,
         person_id ,
         org_id ,
         status_id ,
